...
import WebDesignOrderModal from "../../Modal/WebDesignOrderModel";
import { AuthContext } from "../../Contexts/AuthProvider";
import DeleteWebModal from "../../Modal/DeleteWebModal";
...
const WebDesign = () => {
  ...
  const {
    ...
    queryKey: ["webDesign"],
    queryFn: () =>
      fetch(`https://ashrafs-servier.vercel.app/web-design`, {
        method: "GET",
        headers: {
