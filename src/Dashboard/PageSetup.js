...
const PageSetup = () => {
  return (
    <div>
      ...
      >
        <h2 className="text-center text-white text-6xl font-medium py-5">
          Facebook Page Setup
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:justify-center lg:items-center gap-5 mt-10 mx-10 pb-10">
          <div>
          ...
          <div>
            <div className="bg-white w-full lg:w-60 rounded-lg overflow-hidden">
              <h2 className="text-center p-5 text-2xl font-semibold text-black bg-[#BABABA]">
                Silver
              </h2>
              <div className="">
                <p className="flex items-center p-3 pb-0 text-md ">
...
Location Mapping 
Tabs & Template Optimization
Content Creation 
Pre-programmed Message Setup
